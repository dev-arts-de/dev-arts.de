...
Der Raspberry Pi unter meinem Schreibtisch läuft ohnehin. Neben DailyDev, das mir täglich Lernbeiträge liefert, wollte ich testen, wie weit ein lokales Sprachmodell auf so einem kleinen Gerät sinnvoll einsetzbar ist. Keine groß angelegte KI-Infrastruktur, keine GPU. Stattdessen ein sparsamer ARM-Prozessor, ein quantisiertes Modell und eine Frage: Was kommt dabei heraus?
