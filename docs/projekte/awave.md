...
**Dateiverwaltung · PHP · Web-Oberfläche · ca. 2020 bis 2021**

awave war ein Werkzeug zur Dateiverwaltung über den Browser. Dateien anlegen, finden, organisieren, gruppieren, alles in einer selbst gebauten Web-Oberfläche auf PHP-Basis. Nie wirklich produktiv, nie richtig fertig. Aber eines der Projekte, das mich am meisten gelehrt hat.
