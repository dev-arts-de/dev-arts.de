...
Browser-basierte End-to-End-Tests mit Playwright, Cypress oder ähnlichem habe ich für Bewerber-Schmiede aufgesetzt. Das ist ein Bereich, in dem ich mir Schritt für Schritt mehr aufgebaut habe – die Tooling-Entscheidungen, Selektoren, Stabilität von Tests gegen dynamische Inhalte. Ich würde mich hier als kompetent, nicht als erfahren bezeichnen.
