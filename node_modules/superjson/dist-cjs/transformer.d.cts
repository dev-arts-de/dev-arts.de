import SuperJSON from './index.cjs';
export declare type PrimitiveTypeAnnotation = 'number' | 'undefined' | 'bigint';
declare type LeafTypeAnnotation = PrimitiveTypeAnnotation | 'regexp' | 'Date' | 'URL';
...
declare type SimpleTypeAnnotation = LeafTypeAnnotation | 'map' | 'set' | 'Error';
